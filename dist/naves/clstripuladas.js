...
class clstripuladas extends clsnaves_1.default {
    constructor(nave, tripuladas, agenciasnaves, combustibleNaves) {
    ...
    crearNave() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (nave) {
                ...
                const result = yield tripuladas_model_1.default.create(this.tripuladas);
                this.newNave = {
                    id: nave.id,
                    Nombre: nave.Nombre,
...
exports.default = clstripuladas;
//# sourceMappingURL=clstripuladas.js.map